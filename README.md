...
A DINOv2 ViT-Small model further pre-trained on over half a million optic disc crops sourced from public datsets from 5 continents trained via self-supervised token reconstruction. Model can be frozen or finetuned for multi-purpose downstream tasks.
